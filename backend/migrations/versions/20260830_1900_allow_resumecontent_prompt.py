"""allow resumecontent prompt

Revision ID: 8d4a1c7f9b2e
Revises: 02b6f9d3a7c5
Create Date: 2026-08-30 19:00:00.000000+00:00
"""
...
revision = '8d4a1c7f9b2e'
down_revision = '02b6f9d3a7c5'
branch_labels = None
depends_on = None
...
def downgrade() -> None:
    op.execute("DELETE FROM prompts WHERE kind = 'resumecontent'")
    op.drop_constraint("kind_known", "prompts", type_="check")
    op.create_check_constraint(
        "kind_known",
        "prompts",
